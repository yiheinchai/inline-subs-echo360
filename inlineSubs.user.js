...
(function () {
  ...
  setTimeout(function () {
    ...
    try {
      ...
      <button class="open_transcript" style="background-color: #00aee4; color: #000f19; font: inherit; border: none;">Show</button>
      <button class="close_transcript" style="background-color: #00aee4; color: #000f19; font: inhert; border: none;">Hide</button>
      `
